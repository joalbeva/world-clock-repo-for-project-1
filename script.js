...
if (checkDropdown == "mexico") {
    nd = new Date(utc + 3600000 * -6); // create new object of the date according to chosen country
...
const MexicohourHand = document.querySelector("[mexico-hour-hand]");
const MexicominuteHand = document.querySelector("[mexico-minute-hand]");
const MexicosecondHand = document.querySelector("[mexico-second-hand]");
...
function setClock() {
const mexicocurrentDate = new Date();

const mexicosecondsRatio = mexicocurrentDate.getSeconds() / 60;
const mexicominutesRatio = (mexicosecondsRatio + mexicocurrentDate.getMinutes()) / 60;
const mexicohoursRatio = (mexicominutesRatio + mexicocurrentDate.getHours()) / 12;

var utc = mexicocurrentDate.getTime() + mexicocurrentDate.getTimezoneOffset() * 60000;
...
setRotation(mexicosecondHand, mexicosecondsRatio);
setRotation(mexicominuteHand, mexicominutesRatio);
setRotation(mexicohourHand, mexicohoursRatio);
